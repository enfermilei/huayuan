        ...
        <span class="sensual-icon" :data-glyph="part.glyph" aria-hidden="true">
          <svg class="sensual-svg" viewBox="0 0 24 24" focusable="false">
            ...
            <g v-else-if="part.glyph === 'drop'">
              <path
                d="M12 3.6 C12 3.6 6.8 11.2 6.8 15.1 C6.8 18.1 9.1 20.4 12 20.4 C14.9 20.4 17.2 18.1 17.2 15.1 C17.2 11.2 12 3.6 12 3.6 Z"
              />
            </g>
            <!-- 胸部：双瓣 -->
            <g v-else-if="part.glyph === 'petal'">
              <path
                d="M8.6 18.4 C5.4 16.2 4.6 11.4 8.2 8.8 C10.4 7.2 12.2 8.6 12.2 11.4 C12.2 8.6 14 7.2 16.2 8.8 C19.8 11.4 19 16.2 15.8 18.4 C14.2 19.5 12.8 19.6 12.2 18.6 C11.6 19.6 10.2 19.5 8.6 18.4 Z"
              />
            </g>
            <!-- 小穴：花蕊 -->
            <g v-else-if="part.glyph === 'stamen'">
              <path
                d="M12 5.2 C13.8 8.2 17.6 8.6 18.4 12 C17.6 15.4 13.8 15.8 12 18.8 C10.2 15.8 6.4 15.4 5.6 12 C6.4 8.6 10.2 8.2 12 5.2 Z"
              />
            ...
            <g v-else>
              <path
                d="M12.2 4.8 C16.8 7.2 19.2 12.4 16.6 16.8 C14.6 20.2 10.2 20.4 8.4 16.6 C6.8 13.2 9.2 8.8 12.2 4.8 Z"
              />
            </g>
          </svg>
        </span>
