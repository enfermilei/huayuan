  ...
  >
    <g class="glyph-float">
      ...
      <g v-else-if="landmarkId === 'spa'" class="glyph-body">
        ...
        <path
          class="glyph-steam s1"
          d="M-4 2 C-5 -2 -2 -5 -3 -8"
          fill="none"
          stroke="#B8DCE8"
          stroke-width="1.4"
        ...
        />
        <path
          class="glyph-steam s2"
          d="M0 1 C-1 -3 2 -5 1 -9"
          fill="none"
          stroke="#C8E6F0"
          stroke-width="1.5"
          stroke-linecap="round"
      ...
      <g v-else-if="landmarkId === 'beach'" class="glyph-body">
        ...
        <path
          class="glyph-wave"
          d="M-9 10 Q-4 7 0 10 Q4 13 9 10"
          fill="none"
          stroke="#5BA8C8"
          stroke-width="1.5"
          stroke-linecap="round"
